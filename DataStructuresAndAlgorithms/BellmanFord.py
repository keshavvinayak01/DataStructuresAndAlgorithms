...
class BellmanFord(object):
	...
	def calculateShortestPath(self, vertexList, edgeList, startVertex):
		...
		for i in xrange(len(vertexList) - 1):
	...
	def getShortestPathto(self, targetVertex):
		...
		if not BellmanFord.HAS_CYCLE : 
			print "Shortest path exists for value: ",targetVertex.minDistance
...
#remove these edges from vertex list to get all positive weight edges.
...
edgeList = (edge1,edge2,edge3,edge4,edge5,edge6,edge7,edge8,edge9,edge10,edge12,edge13,edge14,edge15,edge16,edge17,edge18,edge19)
